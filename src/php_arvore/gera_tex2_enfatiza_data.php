...
// VPM 2023-01-06: esta versao "enfatiza_data" coloca underline nos paragrafos que foram criados na data passada como parametro na URL


if(isset($_GET["mode"])){
  $param_mode= $_GET["mode"];
} else $param_mode = "verbose_data"; // quiet ou verbose ou debug ou verbose_data
...
//		$id_pai               = $row["id_pai"]; 
		...
		$tem_filho	          = $row["tem_filho"];
		//echo $nivel.") [".$nome_tipo_secao."] ".$id_secao." - ".$titulo."\n";
		$data_versao_matriz = explode(" ", $data_versao);
