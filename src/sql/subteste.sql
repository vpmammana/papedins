...
mysql -u root -ptoninho13 papedins_db -N -e "
SELECT
...
ORDER BY
    gdt.acentuada, sub_colchetes.elemento_colchetes, sub_chaves.elemento_chaves;
" | grep -v  "\-\-" | awk '{print "INSERT INTO duplos_tokens_para_grupos_de_tokens (id_grupo_de_token, id_token_evidencia, id_token_veiculo) VALUES ("$2","$4","$6");";  }' 
