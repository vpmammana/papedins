...
INSERT INTO grupos_vs_tipos_de_veiculos_n_to_n (nome_grupo_vs_tipo_de_veiculo_n_to_n, nome_grupo_de_token, id_grupo_de_token, nome_tipo_de_veiculo, id_tipo_de_veiculo) VALUES ("<Material Didático>[produção editorial]","material_didatico",(SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "material_didatico"),"produção editorial", (SELECT id_chave_tipo_de_veiculo FROM tipos_de_veiculos WHERE nome_tipo_de_veiculo = "produção editorial"));
