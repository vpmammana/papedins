...
SELECT * from grupos_vs_tipos_de_veiculos_n_to_n;
SELECT "vai inserir um novos grupos para tokens com grupos ja definidos";

# aqui tem que colocar IGNORE porque se o token está com o campo do grupos padrao definido, ele já é acima acima para o grupo, e se inserir novamente, vai dar erro de chave duplicada
# mas se vc quer fazer a insercao para outro grupo, não haverá problema

INSERT IGNORE INTO grupos_vs_tipos_de_evidencias_n_to_n (nome_grupo_vs_tipo_de_evidencia_n_to_n, nome_grupo_de_token, id_grupo_de_token, nome_tipo_de_evidencia, id_tipo_de_evidencia) VALUES ("<orientacoes>[doutorado]","orientacoes",(SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "orientacoes"),"doutorado", (SELECT id_chave_tipo_de_evidencia FROM tipos_de_evidencias WHERE nome_tipo_de_evidencia = "doutorado"));

INSERT IGNORE INTO grupos_vs_tipos_de_evidencias_n_to_n (nome_grupo_vs_tipo_de_evidencia_n_to_n, nome_grupo_de_token, id_grupo_de_token, nome_tipo_de_evidencia, id_tipo_de_evidencia) VALUES ("<orientacoes>[mestrado]","orientacoes",(SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "orientacoes"),"mestrado", (SELECT id_chave_tipo_de_evidencia FROM tipos_de_evidencias WHERE nome_tipo_de_evidencia = "mestrado"));
...
INSERT IGNORE INTO grupos_vs_tipos_de_veiculos_n_to_n (nome_grupo_vs_tipo_de_veiculo_n_to_n, nome_grupo_de_token, id_grupo_de_token, nome_tipo_de_veiculo, id_tipo_de_veiculo) VALUES ("<editoracoes>[produção editorial]","editoracoes",(SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"),"produção editorial", (SELECT id_chave_tipo_de_veiculo FROM tipos_de_veiculos WHERE nome_tipo_de_veiculo = "produção editorial"));
...
INSERT IGNORE INTO grupos_vs_tipos_de_veiculos_n_to_n (nome_grupo_vs_tipo_de_veiculo_n_to_n, nome_grupo_de_token, id_grupo_de_token, nome_tipo_de_veiculo, id_tipo_de_veiculo) VALUES ("<Orientações>[monografia]","orientacoes",(SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "orientacoes"),"monografia", (SELECT id_chave_tipo_de_veiculo FROM tipos_de_veiculos WHERE nome_tipo_de_veiculo = "monografia"));
