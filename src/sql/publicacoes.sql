...
INSERT INTO tipos_de_identificadores (nome_tipo_de_identificador, requerido, nivel_exposicao, ordem_exposicao) VALUES ("SEI", TRUE, 100, 2);
INSERT INTO tipos_de_identificadores (nome_tipo_de_identificador, requerido, nivel_exposicao, ordem_exposicao) VALUES ("TIPO_DOCUMENTO", TRUE, 90,4);
...
INSERT INTO tipos_de_identificadores (nome_tipo_de_identificador, requerido, nivel_exposicao, ordem_exposicao) VALUES ("HASH_URL", TRUE, 0, 150);
INSERT INTO tipos_de_identificadores (nome_tipo_de_identificador, requerido, nivel_exposicao, ordem_exposicao) VALUES ("URL", TRUE, 55, 15);
...
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_DOI", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "DOI"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_URL", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "URL"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_VOLUME", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "VOLUME"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_NUMERO", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "NUMERO"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_PAGINA_INICIAL", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "PAGINA_INICIAL"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_PAGINA_FINAL", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "PAGINA_FINAL"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_TITULO_PERIODICO", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "TITULO_PERIODICO"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("publicacoes_em_periodicos_TITULO_ARTIGO", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "publicacoes_em_periodicos"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "TITULO_ARTIGO"));
...
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_ISBN", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "ISBN"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_DOI", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "DOI"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_URL", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "URL"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_VOLUME", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "VOLUME"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_NUMERO", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "NUMERO"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_PAGINA_INICIAL", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "PAGINA_INICIAL"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_PAGINA_FINAL", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "PAGINA_FINAL"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_ANO", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "ANO"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_MES", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "MES"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_DIA", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "DIA"));
INSERT INTO grupos_vs_identificadores (nome_grupo_vs_identificador, id_grupo_de_token, id_tipo_de_identificador) VALUES ("capitulos_de_livro_TITULO_LIVRO", (SELECT id_chave_grupo_de_token FROM grupos_de_tokens WHERE nome_grupo_de_token = "editoracoes"), (SELECT id_chave_tipo_de_identificador FROM tipos_de_identificadores WHERE nome_tipo_de_identificador = "TITULO_LIVRO"));
