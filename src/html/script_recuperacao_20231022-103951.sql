...
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('estabelecimento', (SELECT id_chave_frase FROM frases where nome_frase='atuar estabelecimento formal no laboratório'), (SELECT id_chave_token FROM tokens WHERE nome_token='estabelecimento' and id_tipo_token='3'), 1);
...
INSERT INTO frases (nome_frase, id_tipo_elemento_sintatico) VALUES ('analisar analista bibliográfico para análise bibliográfica',1);

INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('analisar', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfico para análise bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='analisar' and id_tipo_token='1'), 0);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('analista', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfico para análise bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='analista' and id_tipo_token='3'), 1);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('bibliográfico', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfico para análise bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='bibliográfico' and id_tipo_token='7'), 2);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('para', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfico para análise bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='para' and id_tipo_token='5'), 3);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('análise', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfico para análise bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='análise' and id_tipo_token='3'), 4);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('bibliográfica', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfico para análise bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='bibliográfica' and id_tipo_token='7'), 5);
