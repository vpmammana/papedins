...
INSERT INTO tipos_de_evidencias (nome_tipo_de_evidencia, id_token) VALUES ('evento',(SELECT id_chave_token FROM tokens WHERE nome_token = 'evento'));
...
INSERT INTO tipos_de_evidencias (nome_tipo_de_evidencia, id_token) VALUES ('oficina',(SELECT id_chave_token FROM tokens WHERE nome_token = 'oficina'));
...
INSERT INTO tipos_de_evidencias (nome_tipo_de_evidencia, id_token) VALUES ('periódico',(SELECT id_chave_token FROM tokens WHERE nome_token = 'periódico'));
