...
INSERT INTO frases (nome_frase, id_tipo_elemento_sintatico) VALUES ('analisar analista bibliográfica até analista bibliográfica',1);

INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('analisar', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfica até analista bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='analisar' and id_tipo_token='1'), 0);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('analista', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfica até analista bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='analista' and id_tipo_token='3'), 1);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('bibliográfica', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfica até analista bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='bibliográfica' and id_tipo_token='7'), 2);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('até', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfica até analista bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='até' and id_tipo_token='5'), 3);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('analista', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfica até analista bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='analista' and id_tipo_token='3'), 4);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('bibliográfica', (SELECT id_chave_frase FROM frases where nome_frase='analisar analista bibliográfica até analista bibliográfica'), (SELECT id_chave_token FROM tokens WHERE nome_token='bibliográfica' and id_tipo_token='7'), 5);
...
INSERT INTO frases (nome_frase, id_tipo_elemento_sintatico) VALUES ('apostilar análise científica após realização científica',1);

INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('apostilar', (SELECT id_chave_frase FROM frases where nome_frase='apostilar análise científica após realização científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='apostilar' and id_tipo_token='1'), 0);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('análise', (SELECT id_chave_frase FROM frases where nome_frase='apostilar análise científica após realização científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='análise' and id_tipo_token='3'), 1);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('científica', (SELECT id_chave_frase FROM frases where nome_frase='apostilar análise científica após realização científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='científica' and id_tipo_token='7'), 2);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('após', (SELECT id_chave_frase FROM frases where nome_frase='apostilar análise científica após realização científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='após' and id_tipo_token='5'), 3);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('realização', (SELECT id_chave_frase FROM frases where nome_frase='apostilar análise científica após realização científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='realização' and id_tipo_token='3'), 4);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('científica', (SELECT id_chave_frase FROM frases where nome_frase='apostilar análise científica após realização científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='científica' and id_tipo_token='7'), 5);

INSERT INTO frases (nome_frase, id_tipo_elemento_sintatico) VALUES ('apoiar aplicativo disciplinar com contrato público',1);

INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('apoiar', (SELECT id_chave_frase FROM frases where nome_frase='apoiar aplicativo disciplinar com contrato público'), (SELECT id_chave_token FROM tokens WHERE nome_token='apoiar' and id_tipo_token='1'), 0);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('aplicativo', (SELECT id_chave_frase FROM frases where nome_frase='apoiar aplicativo disciplinar com contrato público'), (SELECT id_chave_token FROM tokens WHERE nome_token='aplicativo' and id_tipo_token='3'), 1);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('disciplinar', (SELECT id_chave_frase FROM frases where nome_frase='apoiar aplicativo disciplinar com contrato público'), (SELECT id_chave_token FROM tokens WHERE nome_token='disciplinar' and id_tipo_token='7'), 2);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('com', (SELECT id_chave_frase FROM frases where nome_frase='apoiar aplicativo disciplinar com contrato público'), (SELECT id_chave_token FROM tokens WHERE nome_token='com' and id_tipo_token='5'), 3);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('contrato', (SELECT id_chave_frase FROM frases where nome_frase='apoiar aplicativo disciplinar com contrato público'), (SELECT id_chave_token FROM tokens WHERE nome_token='contrato' and id_tipo_token='3'), 4);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('público', (SELECT id_chave_frase FROM frases where nome_frase='apoiar aplicativo disciplinar com contrato público'), (SELECT id_chave_token FROM tokens WHERE nome_token='público' and id_tipo_token='7'), 5);
