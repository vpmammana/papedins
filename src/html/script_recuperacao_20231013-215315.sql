...
INSERT INTO frases (nome_frase, id_tipo_elemento_sintatico) VALUES ('credenciar apostila bibliográfica de apresentação científica',1);

INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('credenciar', (SELECT id_chave_frase FROM frases where nome_frase='credenciar apostila bibliográfica de apresentação científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='credenciar' and id_tipo_token='1'), 0);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('apostila', (SELECT id_chave_frase FROM frases where nome_frase='credenciar apostila bibliográfica de apresentação científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='apostila' and id_tipo_token='3'), 1);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('bibliográfica', (SELECT id_chave_frase FROM frases where nome_frase='credenciar apostila bibliográfica de apresentação científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='bibliográfica' and id_tipo_token='7'), 2);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('de', (SELECT id_chave_frase FROM frases where nome_frase='credenciar apostila bibliográfica de apresentação científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='de' and id_tipo_token='5'), 3);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('apresentação', (SELECT id_chave_frase FROM frases where nome_frase='credenciar apostila bibliográfica de apresentação científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='apresentação' and id_tipo_token='3'), 4);
INSERT INTO tokens_nas_frases (nome_token_na_frase, id_frase, id_token, ordem) VALUES ('científica', (SELECT id_chave_frase FROM frases where nome_frase='credenciar apostila bibliográfica de apresentação científica'), (SELECT id_chave_token FROM tokens WHERE nome_token='científica' and id_tipo_token='7'), 5);
